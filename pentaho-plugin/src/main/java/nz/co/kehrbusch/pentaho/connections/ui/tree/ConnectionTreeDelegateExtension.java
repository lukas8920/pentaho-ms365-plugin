...
@ExtensionPoint(id = "MS365ConnectionTreeDelegateExtension", description = "",
...
public class ConnectionTreeDelegateExtension implements ExtensionPointInterface {
    ...
    public void callExtensionPoint(LogChannelInterface log, Object extension) throws KettleException {
        ...
        if ( path[ 2 ].equals( ConnectionFolderProvider.STRING_MS365_CONNECTIONS ) ) {
            switch ( caseNumber ) {
                case 3:
                    object = new TreeSelection( path[ 2 ], Object.class, meta );
                    break;
                case 4:
                    try {
