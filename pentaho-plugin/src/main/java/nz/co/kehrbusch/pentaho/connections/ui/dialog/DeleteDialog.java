...
public class DeleteDialog extends Dialog {
    private static Class<?> PKG = DeleteDialog.class;
    ...
    public int open( String connectionName ) {
        ...
        shell.setText( BaseMessages.getString( PKG, "DeleteDialog.Title" ) );
        ...
        wlMessage.setText( BaseMessages.getString( PKG, "DeleteDialog.Label.Confirmation", connectionName ) );
        ...
        wbYes.setText( BaseMessages.getString( PKG, "DeleteDialog.Label.Yes" ) );
